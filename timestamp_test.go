...
func TestTimestampTwoLinesNinetySecondsNoDateColored(t *testing.T) {
	if os.Getenv("TZ") != "UTC" {
		t.Fail()
		t.Logf("Run tests with TZ=UTC!")
		return
	...
	WantsTimeStamp = true
	timestamp(c, in, &outB, true)
	wantS := "21:16:39.000000 00:01:30.000000 \033[31m00:01:30.000000\033[0m foo\n21:18:09.000000 00:03:00.000000 \033[31m00:01:30.000000\033[0m bar\n"
	if outB.String() != wantS {
		t.Fail()
		t.Logf("GOT  bytes: %v", outB)
		t.Logf("WANT string:\n%v", wantS)
...
func TestTimestampTwoLinesNinetySecondsNoDateNoTimeColored(t *testing.T) {
	if os.Getenv("TZ") != "UTC" {
		t.Fail()
		t.Logf("Run tests with TZ=UTC!")
		return
	...
	timestamp(c, in, &outB, true)
	wantS := "00:01:30.000000 \033[31m00:01:30.000000\033[0m foo\n00:03:00.000000 \033[31m00:01:30.000000\033[0m bar\n"
	if outB.String() != wantS {
		t.Fail()
		t.Logf("GOT  bytes: %v", outB)
		t.Logf("WANT string:\n%v", wantS)
